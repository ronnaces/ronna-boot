...
import com.ronnaces.ronna.boot.system.component.authentication.config.AuthProperties;
import com.ronnaces.ronna.boot.system.component.authentication.contanst.AuthResponseStatusCodes;
    ...
    public List<Router> userRouter(String username) {
        ...
        permissionList.forEach(item -> {
            ...
            router.setMeta(Meta.builder()
                    .title(item.getName()).icon(item.getIcon()).hideChildrenInMenu(false).build());
